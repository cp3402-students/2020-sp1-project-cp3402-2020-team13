    ...
    private function display_role_controls($role_slug, $role_data)
    {
        ...
        <div class="elementor-role-row <?php echo esc_attr($role_slug); ?>">
            <div class="elementor-role-label">
                ...
                <span data-excluded-label="<?php esc_attr_e('Role Excluded', 'elementor'); ?>"
                ...
                <div class="elementor-role-control">
                    <label>
                        <input type="checkbox" name="elementor_exclude_user_roles[]"
                               value="<?php echo esc_attr($role_slug); ?>"<?php checked(in_array($role_slug, $excluded_options, true), true); ?>>
    ...
    public function get_go_pro_link_html()
    {
        ...
        <div class="elementor-role-go-pro">
            ...
            <div class="elementor-role-go-pro__link"><a
                        ...
                        href="<?php echo esc_url($pro_link); ?>"><?php echo __('Go Pro', 'elementor'); ?></a></div>
        </div>
        <?php
    }
