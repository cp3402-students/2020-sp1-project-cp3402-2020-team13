    ...
    function codepeople_add_promote_banner($wp_admin_bar)
    {
        ...
        if (isset($_POST['codepeople_promote_banner_nonce']) && wp_verify_nonce($_POST['codepeople_promote_banner_nonce'], __FILE__)) {
            if (!empty($_POST['codepeople_promote_banner_plugin'])) {
                $_POST['codepeople_promote_banner_plugin'] = sanitize_text_field($_POST['codepeople_promote_banner_plugin']);
                if (!empty($codepeople_promote_banner_plugins[$_POST['codepeople_promote_banner_plugin']])) {
        ...
        foreach ($codepeople_promote_banner_plugins as $plugin_slug => $plugin_data) {
            ...
            if ($minimum_days <= abs($now - $value) && 0 < $value * 1) {
                ?>
                <style>
                    #codepeople-review-banner {
                        width: calc(100% - 20px);
                        width: -webkit-calc(100% - 20px);
                        width: -moz-calc(100% - 20px);
                        width: -o-calc(100% - 20px);
                        border: 10px solid #1582AB;
                        background: #FFF;
                        display: table;
                    }

                    #codepeople-review-banner form {
                        float: left;
                        padding: 0 5px;
                    }

                    #codepeople-review-banner .codepeople-review-banner-picture {
                        width: 120px;
                    ...
                    #codepeople-review-banner .codepeople-review-banner-content {
                        float: left;
                        padding: 10px;
                    ...
                    #codepeople-review-banner .codepeople-review-banner-buttons {
                        padding-top: 20px;
                    }

                    #codepeople-review-banner .no-thank-button,
                    #codepeople-review-banner .main-button {
                        height: 28px;
                        border-width: 1px;
                        border-style: solid;
                        border-radius: 5px;
                    ...
                    #codepeople-review-banner .main-button:hover, #codepeople-review-banner .main-button:focus {
                        background: #008ec2;
                        border-color: #006799;
                        color: #fff;
                    }
                    ...
                    #codepeople-review-banner .no-thank-button:focus {
                        background: #fafafa;
                        border-color: #999;
                        color: #23282d;
                    }
                ...
                <div id="codepeople-review-banner">
                    <div class="codepeople-review-banner-picture">
                        <img alt=""
                             src="https://secure.gravatar.com/avatar/c0662edcefb5a4e2ab12803856ba2358?s=150&amp;d=mm&amp;r=g"
                             style="width:80px;">
                    </div>
                    <div class="codepeople-review-banner-content">
                        <div class="codepeople-review-banner-text">
                            <p><strong>Want to help to the development of the
                                    "<?php print $plugin_data['plugin_name']; ?>" plugin?</strong> The main features of
                                this plugin are provided free of charge. We need your help to continue developing it and
                                adding new features. If you want to help with the development please <span
                                        style="color:#1582AB;font-weight:bold;">add a review to support it</span>. Thank
                                you!</p>
                        </div>
                        <div class="codepeople-review-banner-buttons">
                            <form method="post" target="_blank">
                                <button class="main-button"
                                        onclick="jQuery(this).closest('[id=\'codepeople-review-banner\']').hide();">
                                    Publish a Review
                                </button>
                                <input type="hidden" name="codepeople_promote_banner_plugin"
                                       value="<?php echo esc_attr($plugin_slug); ?>"/>
                                <input type="hidden" name="codepeople_promote_banner_action" value="set-review"/>
                                <input type="hidden" name="codepeople_promote_banner_nonce"
