    ...
    class ACF_Admin_Tool_Export extends ACF_Admin_Tool
    {
        ...
        function html_panel_selection()
        {
            ...
            <div class="acf-panel acf-panel-selection">
                <h3 class="acf-panel-title"><?php _e('Select Field Groups', 'acf') ?> <i
                            class="dashicons dashicons-arrow-right"></i></h3>
        ...
        function html_panel_settings()
        {
            ...
            <div class="acf-panel acf-panel-settings">
                <h3 class="acf-panel-title"><?php _e('Settings', 'acf') ?> <i
                            class="dashicons dashicons-arrow-right"></i></h3>
                <div class="acf-panel-inside">
                    <?php
        ...
        function html_archive()
        {
            ...
            <p class="acf-submit">
                <button type="submit" name="action" class="button button-primary"
                        value="download"><?php _e('Export File', 'acf'); ?></button>
                <button type="submit" name="action" class="button"
                        value="generate"><?php _e('Generate PHP', 'acf'); ?></button>
            </p>
            <?php
