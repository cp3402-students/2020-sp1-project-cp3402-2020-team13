        ...
        playNext: function (is_next) {
            ...
            if (l) { // If playlist is not empty
                ...
                if (me.random) {
                    ...
                    if ((l - 1 == i && is_next) || (i == 0 && !is_next)) { // if it is last - stop playing or jump to the first item
                        if (me.loop) {
                            if (is_next) j = 0;
                            else j = l - 1;
                            valid = true;
