...
if (!class_exists('AVP_PAGE_BUILDERS')) {
    class AVP_PAGE_BUILDERS
    {
        ...
        public static function init()
        {
            ...
            add_action('elementor/controls/controls_registered', array($instance, 'elementor_register_control'));
        }
        ...
        {
            wp_enqueue_style('cpmp-gutenberg-editor-style', CPMP_PLUGIN_URL . '/css/gutenberg.css');
            wp_enqueue_script('cpmp-gutenberg-editor', CPMP_PLUGIN_URL . '/js/gutenberg.js', array('jquery'));
