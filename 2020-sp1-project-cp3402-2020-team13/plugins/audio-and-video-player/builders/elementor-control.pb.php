...
class CPM_Media_Button extends Control_Button
{
    ...
    {
        wp_enqueue_media();
        wp_enqueue_script('cpmp-elementor-control-script', plugin_dir_url(__FILE__) . 'elementor.js', array('jquery'));
    }
...
Plugin::instance()->controls_manager->register_control('cpmmediabutton', new CPM_Media_Button);
Plugin::instance()->controls_manager->register_control('cpmskinselect', new CPM_Skin_Select);