...
class Element_Section extends Element_Base
{
            ...
            if ($settings['background_video_link']) :
                ...
                <div <?php echo $this->get_render_attribute_string('background-video-container'); ?>>
                    ...
                    <?php
                        ...
                        ?>
                        <video
                                class="elementor-background-video-hosted elementor-html5-video" <?php echo $video_tag_attributes; ?>></video>
                    <?php endif; ?>
                </div>
            <?php
            endif;
    ...
    private function print_shape_divider($side)
    {
        ...
        ?>
        <div class="elementor-shape elementor-shape-<?php echo esc_attr($side); ?>"
             data-negative="<?php echo var_export($negative); ?>">
