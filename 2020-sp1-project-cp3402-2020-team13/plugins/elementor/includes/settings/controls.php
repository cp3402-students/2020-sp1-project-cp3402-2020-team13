...
class Settings_Controls
{
    ...
    private static function text(array $field)
    {
        ...
        <input type="<?php echo esc_attr($field['type']); ?>" id="<?php echo esc_attr($field['id']); ?>"
               ...
               value="<?php echo esc_attr(get_option($field['id'], $field['std'])); ?>" <?php echo $attributes; ?>/>
        <?php
    ...
    private static function checkbox(array $field)
    {
        ...
        <label>
            <input type="<?php echo esc_attr($field['type']); ?>" id="<?php echo esc_attr($field['id']); ?>"
                   name="<?php echo esc_attr($field['id']); ?>"
                   value="<?php echo $field['value']; ?>"<?php checked($field['value'], get_option($field['id'], $field['std'])); ?> />
            <?php
            if (!empty($field['sub_desc'])) :
                echo $field['sub_desc'];
            endif;
    ...
    private static function select(array $field)
    {
        ...
        <select name="<?php echo esc_attr($field['id']); ?>">
            ...
            <?php foreach ($field['options'] as $value => $label) : ?>
                <option
                        value="<?php echo esc_attr($value); ?>"<?php selected($value, $old_value); ?>><?php echo $label; ?></option>
            <?php endforeach; ?>
        </select>
    ...
    private static function checkbox_list(array $field)
    {
        ...
        foreach ($field['options'] as $option_key => $option_value) :
            ?>
            <label>
                <input type="checkbox" name="<?php echo esc_attr($field['id']); ?>[]"
                       value="<?php echo esc_attr($option_key); ?>"<?php checked(in_array($option_key, $old_value), true); ?> />
