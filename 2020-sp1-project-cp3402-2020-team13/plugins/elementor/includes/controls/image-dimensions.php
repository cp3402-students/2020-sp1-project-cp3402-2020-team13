            ...
            <div class="elementor-control-input-wrapper">
                <div class="elementor-image-dimensions-field elementor-control-unit-2">
                    ...
                    <label for="<?php echo $control_uid; ?>"
                           class="elementor-image-dimensions-field-description"><?php echo __('Width', 'elementor'); ?></label>
                </div>
                ...
                <div class="elementor-image-dimensions-field elementor-control-unit-2">
                    ...
                    <label for="<?php echo $control_uid; ?>"
                           class="elementor-image-dimensions-field-description"><?php echo __('Height', 'elementor'); ?></label>
                </div>
                <button
                        class="elementor-button elementor-button-success elementor-image-dimensions-apply-button"><?php echo __('Apply', 'elementor'); ?></button>
            </div>
        </div>
        <?php
    }
