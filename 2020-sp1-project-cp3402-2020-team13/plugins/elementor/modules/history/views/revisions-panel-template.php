...
<script type="text/template" id="tmpl-elementor-panel-revisions-no-revisions">
    ...
    <div class="elementor-nerd-box-message">{{{ elementor.translate( elementor.config.document.revisions.enabled ?
        'no_revisions_1' : 'revisions_disabled_1' ) }}}
    </div>
    <div class="elementor-nerd-box-message">{{{ elementor.translate( elementor.config.document.revisions.enabled ?
        'no_revisions_2' : 'revisions_disabled_2' ) }}}
    </div>
</script>
    ...
    <div class="elementor-revision-item__wrapper {{ type }}">
        ...
        <div class="elementor-revision-item__details">
            ...
            <div class="elementor-revision-meta">
                <span>{{{ elementor.translate( type ) }}}</span> <?php echo __('By', 'elementor'); ?> {{{ author }}}
            </div>
        </div>
