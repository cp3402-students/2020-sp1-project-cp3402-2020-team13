...
class CodePeopleMediaPlayer
{
    ...
    */
    ...
    function admin_page()
    {
        ...
        wp_enqueue_media();
        ?>
        <style>.cpm-disabled, .cpm-disabled * {
        ...
        if (
                ...
                <form method="post" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>">
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            ...
                            <input type="submit" value="<?php esc_attr_e(__('Edit media player', CPMP_LANG)); ?>"
                                   class="button-primary">
                            <input type="button" value="<?php esc_attr_e(__('Remove media player', CPMP_LANG)); ?>"
                                   class="button-primary" onclick="cpmp.remove_player();">
            ...
            <form method="post" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>">
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <input type="radio" name="player_type" value="audio" checked> <?php _e('Audio', CPMP_LANG); ?>
                        <input type="radio" name="player_type" value="video"> <?php _e('Video', CPMP_LANG); ?> <input
                            type="submit" value="<?php esc_attr_e(__('Create new media player')); ?>"
                            class="button-primary"/>
                    </div>
                </div>
            </form>
            ...
            <div class="postbox cpm-disabled">
                ...
                <div class="inside">
                    ...
                    <div><input type="button" value="<?php esc_attr_e(__('Save PayPal settings', CPMP_LANG)); ?>"
                                class="button-primary" disabled/></div>
                </div>
            </div>
            </div>
            <style>#wpfooter {
            ...
            ?>
            <div class="wrap">
                <form id="cpmp_media_player_form" method="post"
                      action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>">
                    <input type="hidden" value="<?php esc_attr_e((isset($config->skin)) ? $config->skin : ''); ?>"
                           name="cpmp_skin"/>
                    <?php
                    ...
                    <div><h1><?php _e('Player shortcode', CPMP_LANG); ?>: [cpm-player
                            id="<?php echo((!empty($player_id)) ? $player_id : 'in progress'); ?>"]</h1></div>
                    <!-- General Settings -->
                    <div class="postbox">
                        ...
                        <div class="inside">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    <th scope="row" nowrap>
                                        <label for="cpmp_player_name"><?php _e('Player name', CPMP_LANG); ?> <span
                                                style="color:red">*</span> :</label>
                                    </th>
                                    <td style="width:100%">
                                        <input type="text" id="cpmp_player_name" name="cpmp_player_name"
                                               value="<?php echo esc_attr((isset($player->player_name)) ? stripslashes($player->player_name) : ""); ?>"/>
                                    </td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="width:100%">
                                        <input type="text" id="cpmp_width" name="cpmp_width"
                                               value="<?php echo esc_attr((isset($config->width)) ? $config->width : ""); ?>"/>
                                        <div id="cpmp_width_info"
                                             style="font-style:italic; color:#666;"><?php _e('Value should be greater than or equal to:', CPMP_LANG);
                                            print($width_limit); ?>
                                            <br/><?php _e('To make the players responsive, essential in mobile devices, <b>enter the player\'s width in percentage</b>, for example: 100%', CPMP_LANG); ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td style="width:100%">
                                        <input type="text" id="cpmp_height" name="cpmp_height"
                                               value="<?php echo esc_attr((isset($config->height)) ? $config->height : ""); ?>"/>
                                        <div id="cpmp_height_info"
                                             style="font-style:italic; color:#666;"><?php _e('Value should be greater than or equal to:', CPMP_LANG);
                                            print($height_limit); ?></div>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <th scope="row">
                                    ...
                                    <td style="width:100%">
                                        <input type="checkbox" id="cpmp_autoplay"
                                               name="cpmp_autoplay" <?php echo((isset($config->autoplay)) ? "checked" : ""); ?> />
                                        <span
                                            style="font-style:italic; color:#666;"><?php _e("Some devices don't allow autoplay", CPMP_LANG); ?></span>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <th scope="row">
                                    ...
                                    <td style="width:100%">
                                        <input type="checkbox" id="cpmp_loop"
                                               name="cpmp_loop" <?php echo((isset($config->loop)) ? "checked" : ""); ?> />
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <th scope="row">
                                    ...
                                    <td style="width:100%">
                                        <input type="checkbox" id="cpmp_preload"
                                               name="cpmp_preload" <?php echo((isset($config->preload) && $config->preload != 'none') ? "checked" : ""); ?> />
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <th scope="row">
                                    ...
                                    <td style="width:100%">
                                        <input type="checkbox" id="cpmp_show_playlist"
                                               name="cpmp_show_playlist" <?php echo((isset($config->playlist)) ? "checked" : ""); ?> />
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                ...
                                <tr>
                                    <td>
                                        <div id="item_form" style="border:1px solid #ddd;padding:10px;">
                                            <h3><?php _e('Enter', CPMP_LANG);
                                                print(" {$player_type} ");
                                                _e('data', CPMP_LANG); ?></h3>
                                            <input type="hidden" name="item_id" id="item_id" value=""/>
                                            <table>
                                                <tbody>
                                                <tr>
                                                    <th>
                                                        <label for="item_annotation"><?php _e('Title', CPMP_LANG); ?>
                                                ...
                                                <tr>
                                                    <th nowrap>
                                                        <label><?php _e($player_type); ?> <span
                                                                style="color:red;">*</span> :</label>
                                                    </th>
                                                    <td>
                                                        <div>
                                                            <input type="text" name="item_file[]" class="item_file"
                                                                   id="item_file" value="">
                                                            <input type="button"
                                                                   title="<?php esc_attr_e(__('Select the item file', CPMP_LANG)); ?>"
                                                                   onclick="avp_select_file( this );"
                                                                   value="<?php esc_attr_e(__('Select File', CPMP_LANG)); ?>"/>
                                                            <a href="javascript:void(0)"
                                                               onclick="cpmp.add_field(this, 'item_file')"
                                                               style="text-decoration:none;">[+] New file format</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        </div>
                                                        <br/>
                                                ...
                                                <tr>
                                                    <td colspan="2"><a href="javascript:void(0);"
                                                                       ...
                                                                       onclick="avp_toggle_additional_attributes(this);"><?php _e('[+] additional attributes', CPMP_LANG); ?></a>
                                                    </td>
                                                </tr>
                                                <tr style="display:none;" class="cpmp-additional-attr">
                                                    <th nowrap>
                                                        <label
                                                            for="item_link"><?php _e('Associated link:', CPMP_LANG); ?></label>
                                                    </th>
                                                    <td>
                                                ...
                                                <?php if ($player_type == 'video') { ?>
                                                    <tr style="display:none;" class="cpmp-additional-attr">
                                                        <th>
                                                            <label
                                                                for="item_poster"><?php _e('Poster:', CPMP_LANG); ?></label>
                                                        </th>
                                                        <td>
                                                            <input type="text" name="item_poster" id="item_poster"
                                                                   class="item_poster"/>
                                                            <input type="button"
                                                                   title="<?php esc_attr_e(__('Select the item poster', CPMP_LANG)); ?>"
                                                                   onclick="avp_select_file( this );"
                                                                   value="<?php esc_attr_e(__('Select Poster', CPMP_LANG)); ?>"/>
                                                            <br/>
                                                            <span style="font-style:italic; color:#666;">
																<?php
                                                    ...
                                                    <td>
                                                        <div>
                                                            <input type="text" name="item_subtitle[]"
                                                                   class="item_subtitle" value=""/>
                                                            <?php _e('Lang: ', CPMP_LANG); ?>
                                                            <input type="text" name="item_subtitle_lang[]"
                                                                   class="item_subtitle_lang" value=""/>
                                                            <input type="button" value="Add new language"
                                                                   onclick="cpmp.add_field(this, 'item_subtitle')">
                                                        </div>
                                                        <br/>
                                                        <span style="font-style:italic; color:#666;">
																<?php
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <input type="button" name="insert_item"
                                                               value="<?php esc_attr_e(__('Add / Update item on playlist', CPMP_LANG)); ?>"
                                                               class="button-primary" onclick="cpmp.add_item();">
                                                        <input type="button" name="clear_item_form"
                                                               value="<?php esc_attr_e(__('Clear', CPMP_LANG)); ?>"
                                                               class="button-primary" onclick="cpmp.clear_item_form();">
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tr valign="top">
                                    <td>
                                        <div id="items_container"
                                             style="border:1px solid #ddd; width:100%; height:200px; overflow:scroll;">
                                            <?php
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <input type="button" class="button"
                                                   value="<?php esc_attr_e(__('Select file', CPMP_LANG)); ?>" disabled/>
                                        </div>
                                    </td>
                                </tr>
                                <tr valign="top">
                    ...
                    <div>
                        <input type="button" id="create" name="create" value="<?php echo $insertion_button_text; ?>"
                               class="button-primary" onclick="cpmp.submit_item_form();"/>
