...
class Admin_Notices extends Module
{
    ...
    private function notice_api_upgrade_plugin()
    {
        ...
        ?>
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed"
             data-notice_id="<?php echo esc_attr($notice_id); ?>">
    ...
    private function notice_api_notice()
    {
        ...
        ?>
        <div class="notice is-dismissible updated elementor-message-dismissed elementor-message-announcement"
             data-notice_id="<?php echo esc_attr($notice_id); ?>">
            ...
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p><?php echo esc_html($tracker_description_text); ?> <a
                                ...
                                target="_blank"><?php echo __('Learn more.', 'elementor'); ?></a></p>
                    <p class="elementor-message-actions">
                        <a href="<?php echo $optin_url; ?>"
                           class="button button-primary"><?php echo __('Sure! I\'d love to help', 'elementor'); ?></a>&nbsp;<a
                                href="<?php echo $optout_url; ?>"
                                class="button-secondary"><?php echo __('No thanks', 'elementor'); ?></a>
                    </p>
                </div>
            </div>
        </div>
    ...
    private function notice_rate_us_feedback()
    {
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed"
            ...
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    <p>
                        <strong><?php echo __('Congrats!', 'elementor'); ?></strong> <?php _e('You created over 10 pages with Elementor. Great job! If you can spare a minute, please help us by leaving a five star review on WordPress.org.', 'elementor'); ?>
                    </p>
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/admin-review/" target="_blank"
                           class="button button-primary"><?php _e('Happy To Help', 'elementor'); ?></a>
                        <a href="<?php echo esc_url_raw($dismiss_url); ?>"
                           class="button elementor-button-notice-dismiss"><?php _e('Hide Notification', 'elementor'); ?></a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed"
            ...
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    ...
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/plugin-promotion-woocommerce/" target="_blank"
                           class="button button-secondary"><?php _e('Learn More', 'elementor'); ?></a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed"
            ...
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    ...
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/plugin-promotion-contactform7/" target="_blank"
                           class="button button-secondary"><?php _e('Learn More', 'elementor'); ?></a>
                    </p>
                </div>
            </div>
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed"
            ...
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    ...
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/plugin-promotion-mc4wp/" target="_blank"
                           class="button button-secondary"><?php _e('Learn More', 'elementor'); ?></a>
                    </p>
                </div>
            </div>
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed"
            ...
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    ...
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/plugin-promotion-popupmaker/" target="_blank"
                           class="button button-secondary"><?php _e('Learn More', 'elementor'); ?></a>
                    </p>
                </div>
            </div>
        ...
        <div class="notice updated is-dismissible elementor-message elementor-message-dismissed"
            ...
            <div class="elementor-message-inner">
                ...
                <div class="elementor-message-content">
                    ...
                    <p class="elementor-message-actions">
                        <a href="https://go.elementor.com/promotion-role-manager/" target="_blank"
                           class="button button-secondary"><?php _e('Learn More', 'elementor'); ?></a>
                    </p>
                </div>
            </div>
