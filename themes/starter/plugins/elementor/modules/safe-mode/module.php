    ...
    public function print_safe_mode_notice()
    {
        ...
        <div class="elementor-safe-mode-toast" id="elementor-safe-mode-message">
            <header>
                ...
                <a class="elementor-safe-mode-button elementor-disable-safe-mode" target="_blank"
                   href="<?php echo $this->get_admin_page_url(); ?>">
            ...
            <div class="elementor-toast-content">
                <ul class="elementor-safe-mode-list">
                    <li class="elementor-safe-mode-list-item">
                        <div
                            class="elementor-safe-mode-list-item-title"><?php echo __('Editor successfully loaded?', 'elementor'); ?></div>
                        <div
                            class="elementor-safe-mode-list-item-content"><?php echo __('The issue was probably caused by one of your plugins or theme.', 'elementor'); ?><?php printf(__('<a href="%s" target="_blank">Click here</a> to troubleshoot', 'elementor'), self::DOCS_HELPED_URL); ?></div>
                    </li>
                    <li class="elementor-safe-mode-list-item">
                        <div
                            class="elementor-safe-mode-list-item-title"><?php echo __('Still experiencing issues?', 'elementor'); ?></div>
                        <div
                            class="elementor-safe-mode-list-item-content"><?php printf(__('<a href="%s" target="_blank">Click here</a> to troubleshoot', 'elementor'), self::DOCS_DIDNT_HELP_URL); ?></div>
                    </li>
                </ul>
                <?php
                ...
                if (1 < count($mu_plugins)) : ?>
                    <div
                        class="elementor-safe-mode-mu-plugins"><?php printf(__('Please note! We couldn\'t deactivate all of your plugins on Safe Mode. Please <a href="%s" target="_blank">read more</a> about this issue.', 'elementor'), self::DOCS_MU_PLUGINS_URL); ?></div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="elementor-safe-mode-toast" id="elementor-try-safe-mode">
            <?php if (current_user_can('install_plugins')) : ?>
                <header>
                    ...
                    <a class="elementor-safe-mode-button elementor-enable-safe-mode" target="_blank"
                       href="<?php echo $this->get_admin_page_url(); ?>">
                ...
                <div class="elementor-toast-content">
                    ...
                    <a href="<?php echo self::DOCS_TRY_SAFE_MODE_URL; ?>"
                       target="_blank"><?php echo __('Learn More', 'elementor'); ?></a>
                </div>
            <?php else : ?>
                <header>
                    <i class="eicon-warning"></i>
