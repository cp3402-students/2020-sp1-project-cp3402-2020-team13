        ...
        <div class="elementor-tabs" role="tablist">
            <div class="elementor-tabs-wrapper">
                ...
                foreach ($tabs as $index => $item) :
                    ...
                    ?>
                    <div <?php echo $this->get_render_attribute_string($tab_title_setting_key); ?>><a
                                href=""><?php echo $item['tab_title']; ?></a></div>
                <?php endforeach; ?>
            </div>
        ...
        <div class="elementor-tabs" role="tablist">
            ...
            <div class="elementor-tabs-wrapper">
                ...
                <div id="elementor-tab-title-{{ tabindex + tabCount }}"
                     class="elementor-tab-title elementor-tab-desktop-title" data-tab="{{ tabCount }}" role="tab"
                     aria-controls="elementor-tab-content-{{ tabindex + tabCount }}"><a href="">{{{ item.tab_title
                        }}}</a></div>
                <# } ); #>
            </div>
            <div class="elementor-tabs-content-wrapper">
